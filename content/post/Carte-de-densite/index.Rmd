---
title: 'Marmap : Carte de densité'
subtitle: 'Comment faire une carte de densité ?'
summary: Créer une carte de densité avec une API google.
authors:
- Miquel Pons
...
Charger les packages nécéssaires  la création d'une carte de densité.
```{r}
library(ggplot2)
library(RgoogleMaps)
library(ggmap)
