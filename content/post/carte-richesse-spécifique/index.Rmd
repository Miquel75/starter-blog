...
On **importe** un set de données comportant uniquement des données de GPS. Ces coordonnées correspondent par exemple à des observations d'élasmobranches (raies et requins) faites en Méditerranée française. On **formate** en s'assurant bien que les données gps sont au format **numeric**
