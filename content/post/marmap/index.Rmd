...
Importer les données (à télécharger ici <a href="/files/poissons.csv">poissons.csv</a> ) et les manipuler pour avoir le tableau qui nous intéresse. 
...
donnees_na <- donnees_filt %>% drop_na(X,Y, NOMCITE)
...
min(donnees_na$LAT)
```
On garde seulement lon lat et une variable qui définit notre observation; ici NOMCITE donne l'espèce
